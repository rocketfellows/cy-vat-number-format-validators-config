...
namespace rocketfellows\CYVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\CYVatNumberFormatValidatorsConfig\CYVatNumberFormatValidatorsConfig;

class CYVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = CYVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = CYVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::CY(), $config->getCountry());
    }
